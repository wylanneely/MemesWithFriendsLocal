...
class MPCeateAMemeViewController: UIViewController, CKMemeImageSelectedDelegate, UICollectionViewDataSource, UICollectionViewDelegate, ColorDelegate, UITextFieldDelegate  {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return MPStoredImages.images.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.delegate = self
        let image = MPStoredImages.images[indexPath.row]
    ...
    @IBAction func createMemeButtonTapped(_ sender: Any) {
        guard let firstText = firstTextField.text,
            ...
            let textColor = firstTextLabel.textColor,
            let image = memeImageView.image else {return}
        guard let game = MPLocalGameController.shared.game else {return}
        
        MPLocalGameController.shared.createMeme(gameRecord: game.cloudKidRecord, image: image, firstText: firstText, secondText: secondText, textColor: textColor, creator: "creatorName")
