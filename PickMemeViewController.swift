...
class PickMemeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, MemeImageSelectedDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "memeImageCell", for: indexPath) as? MemeImageCollectionViewCell else { return UICollectionViewCell()}
        cell.delegate = self
    ...
    func memeImageButtonTappped(cell: MemeImageCollectionViewCell) {
